  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover FlashSwap, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for CAKE."
        />
        ...
        <meta name="twitter:title" content="🥞 FlashSwap - A next evolution DeFi exchange on BNB Smart Chain (BSC)" />
